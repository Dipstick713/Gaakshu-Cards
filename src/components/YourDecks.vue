...
<template>
  <div class="bg-gray-900 text-white">
    ...
    <div class="flex flex-wrap ">
      <button v-for="deck in displayedDecks" :key="deck.id" @click="handleDeckSelect(deck.id)" class="w-64 h-40 m-2 bg-gray-800 rounded-lg p-4 flex flex-col items-center justify-center hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-colors duration-300">
