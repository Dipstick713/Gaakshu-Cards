...
const decks = ref([
  { id: 1, name: "General Knowledge", cardCount: 10 },
  { id: 2, name: "Science", cardCount: 15 },
  { id: 3, name: "Literature", cardCount: 8 },
  { id: 4, name: "History", cardCount: 12 },
  { id: 5, name: "Mathematics", cardCount: 20 },
  { id: 6, name: "Geography", cardCount: 18 },
]);

const emit = defineEmits(['selectDeck']);

const handleDeckSelect = (deckId) => {
  emit('selectDeck', deckId);
};
</script>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      >
        <div class="flex items-center mb-2">
          ...
          <span class="text-white font-medium">{{ deck.name }}</span>
        </div>
